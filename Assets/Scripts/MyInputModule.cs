    ...
    public class MyInputModule : PointerInputModule
    {
        ...
        protected void ProcessTouchPress(PointerEventData pointerEvent, bool pressed, bool released)
        {
            ...
            if (pressed)
            {
                ...
                if (EventSystem.current.IsPointerOverGameObject() && EventSystem.current.currentSelectedGameObject.CompareTag("Button"))
                {
        ...
        protected void ProcessMousePress(MouseButtonEventData data)
        {
            ...
            if (data.PressedThisFrame())
            {
                ...
                if (EventSystem.current.IsPointerOverGameObject() && EventSystem.current.currentSelectedGameObject != null && EventSystem.current.currentSelectedGameObject.CompareTag("Button"))
                {
                    DeselectIfSelectionChanged(currentOverGo, pointerEvent);
                }
